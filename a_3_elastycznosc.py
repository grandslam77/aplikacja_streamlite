...
# df = pd.read_excel("zestaw_18.xlsx")
df = pd.read_excel("elastycznosci.xlsx")
...
def get_random_questions(df, n=3):
...
def initialize_questions(df, n=3):
