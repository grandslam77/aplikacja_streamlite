...
# Funkcja usuwająca przedrostek liczbowy z wartości
...
df = pd.read_excel("zestaw_20.xlsx")

# Normalizacja kolumn z przedrostkami
df['Kod_Testu'] = df['Kod_Testu'].apply(remove_prefix)
df['Klucz_Wiersza'] = df['Klucz_Wiersza'].apply(remove_prefix)

# Funkcja losująca pytania na podstawie "Kod_Testu" i "Numer_Pytania"
